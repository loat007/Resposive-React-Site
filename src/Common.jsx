            ...
            <div className="col-10 mx-auto">
              <div className="row">
                <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center ">
                  <h1>
                  {props.name} <strong className='brand-name'>Developers Place</strong>
                  ...
                  <div className="mt-3">
                    <NavLink to={props.visit} exact type="button" className="btn btn-outline-primary"> {props.btnname} </NavLink>
                  </div>
                </div>
